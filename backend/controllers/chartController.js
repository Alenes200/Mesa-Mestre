...
const chartController = {
  ...
  getComandasPorDiaSemana: async (req, res) => {
    try {
      ...
      const result = await chartRepository.getComandasPorDiaSemana(
        dataInicio,
        dataFim
      );
  ...
  getFaturamentoDiario: async (req, res) => {
    try {
      const { dataInicio, dataFim } = req.query;
      const result = await chartRepository.getFaturamentoDiario(
        dataInicio,
        dataFim
      );
  ...
  getFormasPagamento: async (req, res) => {
    try {
      const { dataInicio, dataFim } = req.query;
      const result = await chartRepository.getFormasPagamento(
        dataInicio,
        dataFim
      );
  ...
  getOcupacaoMesas: async (req, res) => {
    try {
      const { dataInicio, dataFim } = req.query;
      const result = await chartRepository.getOcupacaoMesas(
        dataInicio,
        dataFim
      );
  ...
  getVendasPorCategoria: async (req, res) => {
    try {
      const { dataInicio, dataFim } = req.query;
      const result = await chartRepository.getVendasPorCategoria(
        dataInicio,
        dataFim
      );
